...
app.get('/', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/cards-page.html'));
    }
    catch(error) {
        console.log(error);
...
app.get('/addcard', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/cards-add-page.html'));
    }
    catch(error) {
        console.log(error);
        res.status(500).json({ error });
...
app.get('/editcard/:id', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/cards-edit-page.html'));
    }
    catch (error) {
        res.status(500).json({ error });
    }
...
app.get('/viewcard/:id', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/cards-view-page.html'));
    }
    catch (error) {
        console.log(error);
        res.status(500).json({ error });
...
app.get('/fighters', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/fighters-page.html'));
    }
    catch (error) {
        console.log(error);
        res.status(500).json({ error });
...
app.get('/addfighter', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/fighters-add-page.html'));
    }
    catch (error) {
        console.log(error);
        res.status(500).json({ error });
...
app.get('/editfighter/:id', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/fighters-edit-page.html'));
    }
    catch (error) {
        res.status(500).json({ error });
    }
...
app.get('/viewfighter/:id', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/fighters-view-page.html'));
    }
    catch (error) {
        console.log(error);
        res.status(500).json({ error });
...
app.get('/fights', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/fights-page.html'));
    }
    catch (error) {
        console.log(error);
        res.status(500).json({ error });
...
app.get('/addfight', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/fights-add-page.html'));
    }
    catch (error) {
        console.log(error);
        res.status(500).json({ error });
...
app.get('/editfight/:id', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/fights-edit-page.html'));
    }
    catch (error) {
        res.status(500).json({ error });
    }
...
app.get('/viewfight/:id', async (req, res) => {
    try {
        res.sendFile(path.join(__dirname, '/frontend/fights-view-page.html'));
    }
    catch (error) {
        console.log(error);
        res.status(500).json({ error });
